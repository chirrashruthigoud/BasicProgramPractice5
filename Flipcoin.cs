...
namespace HelloWorld
{
    ...
    {
        public static double CalculatePercentage(int flipcoin,string name)
        {
            int head = 0;
            int tail = 0;
            int headcount = 0;
           ...
           //onsole.WriteLine("Enter a value for flipCoin :-");
           //intflipCoin = Convert.ToInt32(Console.ReadLine());
